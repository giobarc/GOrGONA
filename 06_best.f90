        ...
        integer,dimension(5000,5000)::p1,p2,p3
        integer,dimension(5000)::p1min,p2min,p3min
        real(kind=8):: e1,d1,ene0,des10 
        real(kind=8),dimension(5000,5000):: ene,des1 
        real(kind=8),dimension(5000):: enemin,des1min 
        character(len=200),dimension(5000):: nfile
        character(len=10),dimension(5000,5000):: nf
        character(len=10),dimension(5000):: nfmin
