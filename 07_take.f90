  ...
  10    format(I6,2F10.4,3I6,4X,A10)
   ...
   2    continue
     ...
     &'.xyz'
            elseif ((n1(i).ge.10).and.(n1(i).lt.100)) then
     ...
     &000',n4(i),'/run_00',n1(i),'/',a1(i),' ./DBFN/MIN00',n1(i),'.xyz'
              elseif ((n1(i).ge.100).and.(n1(i).lt.1000)) then
                write(1,'(A15,I1,A6,I3,A1,A10,A12,I3,A4)') 'cp ./motifs/&
     ...
     &0',n4(i),'/run_',n1(i),'/',a1(i),' ./DBFN/MIN',n1(i),'.xyz'
            ...
            elseif ((n4(i).ge.1000).and.(n4(i).lt.10000)) then
              if (n1(i).lt.10) then
                write(1,'(A12,I4,A8,I1,A1,A10,A14,I1,A4)') 'cp ./motifs/&
     &',n4(i),'/run_000',n1(i),'/',a1(i),' ./DBFN/MIN000',n1(i),'.xyz'
              elseif ((n1(i).ge.10).and.(n1(i).lt.100)) then
                write(1,'(A12,I4,A7,I2,A1,A10,A13,I2,A4)') 'cp ./motifs/&
     &',n4(i),'/run_00',n1(i),'/',a1(i),' ./DBFN/MIN00',n1(i),'.xyz'
              elseif ((n1(i).ge.100).and.(n1(i).lt.1000)) then
                write(1,'(A12,I4,A6,I3,A1,A10,A12,I3,A4)') 'cp ./motifs/&
     &',n4(i),'/run_0',n1(i),'/',a1(i),' ./DBFN/MIN0',n1(i),'.xyz'
              elseif ((n1(i).ge.1000).and.(n1(i).lt.10000)) then
                write(1,'(A12,I4,A5,I4,A1,A10,A11,I4,A4)') 'cp ./motifs/&
     &',n4(i),'/run_',n1(i),'/',a1(i),' ./DBFN/MIN',n1(i),'.xyz'
              endif
            endif
          endif
        enddo
